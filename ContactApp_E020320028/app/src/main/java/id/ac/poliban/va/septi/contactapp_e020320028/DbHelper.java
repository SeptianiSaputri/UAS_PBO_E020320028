package id.ac.poliban.va.septi.contactapp_e020320028;
...
public class DbHelper extends SQLiteOpenHelper {
    ...
    public DbHelper(@Nullable Context context) {
        super(context, id.ac.poliban.va.septi.contactapp_e020320028.Constants.DATABASE_NAME, null, Constants.DATABASE_VERSION);
    }
